        ...
        if group_id:
            ...
            if utils.valid_test_name(group_name):
                if group_get(models.LOG_KEY):
                    directory_path = os.path.join(utils.BASE_PATH,
                    ...
                    filename = "{}.txt".format("-".join((group_get(models.NAME_KEY), group_get(models.BOARD_KEY))))
                    kci_test._add_test_log(directory_path, filename, group_get(models.LOG_KEY))
